...
import { TemplateWithNestedStackCount } from './nested-stack-helpers';
...
export declare class Deployments {
    ...
    readCurrentTemplateWithNestedStacks(rootStackArtifact: cxapi.CloudFormationStackArtifact, retrieveProcessedTemplate?: boolean): Promise<TemplateWithNestedStackCount>;
